...
import ProjectDetailsImg1 from "../../assets/images/project/tomato-3900264_1920.jpg";
import ProjectDetailsImg2 from "../../assets/images/project/tomatoes-1561565.jpg";
import ProjectDetailsImg3 from "../../assets/images/project/tomates.jpg";
...
const ProjectContent = () => {
  return (
    <div className="project-details-wrapper">
      ...
      <h2 className="mb-30">Conditions De Culture</h2>
      <p>
        But I must explain to you how all this mistaken idea of denouncing
        pleasure and praising pain was born give you a complete account of the
        ...
        <br /> <br /> But because those who do not know how to pursue pleasure
        ...
        itself, it is pain, but because occasionally circumstances occur in
        which toil and pain can procure him some great pleasure. To take a
        trivial example,
      </p>
      <h2 className="mt-40 mb-20">Conservation & Distribution</h2>
      <p className="mb-45">
        But I must explain to you how all this mistaken idea of denouncing
        pleasure and praising pain was born and I will give you a complete
        account of the system, and expound the actual teachings of the great
        explorer of the truth, the master-builder of human happiness. No one
        rejects, dislikes, or avoids pleasure because it is pleasure,
      </p>
